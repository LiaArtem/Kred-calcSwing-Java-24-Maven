...
public class Kred_calculator extends javax.swing.JFrame {
    ...
    private void curr_codeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_curr_codeActionPerformed
        ...
        if ("UAH".equals(text)) {
            this.kurs.setValue(Float.valueOf("1"));
     ...
     try {
        ...
        for (int s = 0; s < nodeLst.getLength(); s++) {
          ...
          if (fstNode.getNodeType() == Node.ELEMENT_NODE) {                         
            ...
            if (checkString_Float(text) == true) {
                this.priv_proc_stavka.setValue(Float.valueOf(text));
            } else {
            ...
            if (checkString_Float(text) == true) {
                this.priv_srok_kred.setValue(Float.valueOf(text));
            } else {
            ...
            text = (message.getTextContent().replace(",", "."));
            if (checkString_Float(text) == true) {
                this.proc_stavka.setValue(Float.valueOf(text));
            } else {
            ...
            text = (message.getTextContent().replace(",", "."));
            if (checkString_Float(text) == true) {
                this.summa.setValue(Float.valueOf(text));
            } else {
            ...
            text = (message.getTextContent().replace(",", "."));
            if (checkString_Float(text) == true) {
                this.kurs.setValue(Float.valueOf(text));
            } else {
            ...
            text = (message.getTextContent().replace(",", "."));
            if (checkString_Float(text) == true) {
                this.perv_vznos.setValue(Float.valueOf(text));
            } else {
                this.perv_vznos.setValue(null);
            }                                                
            // perv_vznos_proc
            ...
            text = (message.getTextContent().replace(",", "."));
            if (checkString_Float(text) == true) {
                this.proc_perv_vznos.setValue(Float.valueOf(text));
            } else {
                this.proc_perv_vznos.setValue(null);
            }                                                
            // srok
            ...
            text = (message.getTextContent().replace(",", "."));
            if (checkString_Float(text) == true) {
                this.srok_kred.setValue(Float.valueOf(text));
            } else {
            ...
            if (null == text) {
                this.type_proc.setSelectedIndex(0);
                  ...
                  case "A" -> this.type_proc.setSelectedIndex(1);
                  case "R" -> this.type_proc.setSelectedIndex(2);
                  default -> this.type_proc.setSelectedIndex(0);
              }
        ...
        for (int s = 0; s < nodeLst.getLength(); s++) {
          ...
          if (fstNode.getNodeType() == Node.ELEMENT_NODE) {                         
            ...
            String text = (message.getTextContent().replace(",", "."));
            if (checkString_Float(text) == true) {
                this.kurs_start.setValue(Float.valueOf(text));
            } else {
            ...
            text = (message.getTextContent().replace(",", "."));
            if (checkString_Float(text) == true) {
                this.kurs_year_0.setValue(Float.valueOf(text));
            } else {
            ...
            text = (message.getTextContent().replace(",", "."));
            if (checkString_Float(text) == true) {
                this.kurs_year_1.setValue(Float.valueOf(text));
            } else {
            ...
            text = (message.getTextContent().replace(",", "."));
            if (checkString_Float(text) == true) {
                this.kurs_year_2.setValue(Float.valueOf(text));
            } else {
            ...
            text = (message.getTextContent().replace(",", "."));
            if (checkString_Float(text) == true) {
                this.kurs_year_3.setValue(Float.valueOf(text));
            } else {
            ...
            text = (message.getTextContent().replace(",", "."));
            if (checkString_Float(text) == true) {
                this.kurs_year_4.setValue(Float.valueOf(text));
            } else {
            ...
            text = (message.getTextContent().replace(",", "."));
            if (checkString_Float(text) == true) {
                this.koef_otsech.setValue(Float.valueOf(text));
            } else {
		...
		return;
            ...
            if ("аннуитетная".equals(m_type_proc))
            {
                ...
                switch (m_type_annuitet) {
                    ...
                    case "факт/360" -> {
                        zc = LastDayOfMonth(this.date_cred.getValue()); zn = 360;
                    }
                    case "факт/факт" -> {
                        zc = LastDayOfMonth(this.date_cred.getValue()); zn = KolDayOfYear(this.date_cred.getValue());
                    }
                    default -> {
                    }
                }
